...
class ProviderService(BaseService):
    ...
    def create(self, data: Dict[str, Any]) -> Provider:
        ...
        self._ensure_unique_value(Provider.nit, data["nit"], f"Ya existe un proveedor con el NIT '{data['nit']}'.")
        self._ensure_unique_value(Provider.email, data["email"], f"Ya existe un proveedor con el correo '{data['email']}'.")
    ...
    def delete(self, provider_id: int) -> Provider:
        """Desactiva el proveedor si no tiene productos activos."""
